  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[#0a0a0a]">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1000ms' }} />
          ...
          <div className="max-w-7xl mx-auto w-full">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <motion.h1 
                  className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-none tracking-tight"
                  style={{
